...
This repository is a fork used as the basis for a CTF-style educational workshop that teaches open source maintainers how to run incident response on their own projects. Participants play as the maintainer team of a project under live attack, working through a scenario inspired by real-world supply chain incidents.

We chose a smart-home bridge as the basis for the scenario because the real-world impact story is genuinely relatable. When a project with access to locks, cameras, and garage doors gets compromised, maintainers in the room immediately grasp what's at stake, and that intuitive understanding is what makes the exercise land.

This fork lives entirely within the workshop environment. It contains artificial scenario elements that do not touch the real upstream project, its infrastructure, or its accounts.
